...
/**
 * Function to set the day of week of a date.
 *
 * @author Vikash Madhow (vikash.madhow@gmail.com)
 */
public class SetDayOfWeek extends Function {
  public SetDayOfWeek() {
    super("setweekday", Types.DateType,
  ...
  public String translate(FunctionCall         call,
    ...
    if (target == POSTGRESQL) {
      return "make_timestamp(date_part('year', "          + arg1 + "), "
                          ...
                          + "date_part('day', " + arg1 + ") + " + arg2 + " - date_part('dow', " + arg1 + "), "
                          + "date_part('hour', "          + arg1 + "), "
      ...
      return "datetime2fromparts(datepart(year, "         + arg1 + "), "
                              + "datepart(month, "        + arg1 + "), "
                              + "datepart('day', " + arg1 + ") + " + arg2 + " - iif(datepart(weekday, " + arg1 + ") = 1, 7, datepart(weekday, " + arg1 + ") - 1), "
                              + "datepart(hour, "         + arg1 + "), "
      ...
      return "new Date(" + arg1 + ".setDate(" + arg1 + ".getDate() + " + arg2 + " - (("  + arg1 + ").getDay() || 7)))";
